...
#include "_mulle-iovec-include.h"

#ifndef MULLE__IOVEC_GLOBAL
# ifdef MULLE__IOVEC_BUILD
#  define MULLE__IOVEC_GLOBAL    MULLE_C_GLOBAL
# else
#  if defined( MULLE__IOVEC_INCLUDE_DYNAMIC) || (defined( MULLE_INCLUDE_DYNAMIC) && ! defined( MULLE__IOVEC_INCLUDE_STATIC))
#   define MULLE__IOVEC_GLOBAL   MULLE_C_GLOBAL
#  else
#   define MULLE__IOVEC_GLOBAL   extern
#  endif
# endif
#endif
