...
#ifndef _mulle_iovec_include_h__
#define _mulle_iovec_include_h__

// To remove the following dependency (headers and library) completely:
//   `mulle-sde dependency remove mulle-core`
// (Use 7CA79244-568D-4DF8-A010-99EF86B35B1E instead of mulle-core, if there are duplicate entries)
//
